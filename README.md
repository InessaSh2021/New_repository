# Шувалова Инесса Борисовна, python-разработчик
...
Ссылка на информационнный блок, созданный с использованием Bootstrap https://main--neon-cat-ff2ad1.netlify.app/index.html
...
### 2023 г. "Веб-разработка для начинающих: HTML и CSS"; "JavaScript для начинающих"; "Тестирование ПО: Postman для тестирования API"; "Практический мини-курс по JavaScript и Bootstrap 5"; "Docker для начинающих + практический опыт"
